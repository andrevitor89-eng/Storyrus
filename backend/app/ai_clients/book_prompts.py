...
_HAIR_LOCK = (
    ...
    "comprimento, risca, volume e se existe ou NAO existe franja. "
...
_FACE_FIDELITY = (
    ...
    "PROIBIDO olhos anime, chibi ou cartoon. "
...
AVATAR_PROMPT = (
    ...
    "Expressao NEUTRA-ALEGRE leve (sorriso suave) — so o rosto-padrao de referencia; "
    "nas cenas do livro a expressao facial MUDARA conforme a historia. Fundo neutro, "
...
CHARACTER_GEN_PREFIX = (
    ...
    f"etnia nem idade. Sem texto, sem moldura, sem marca d'agua. {_FACE_FIDELITY} "
...
REFINE_IDENTITY_PROMPT = (
    ...
    "infantil. "
    f"{_FACE_FIDELITY} {_HAIR_LOCK} {_WATERMARK_LOCK} "
    ...
    "tamanho da foto (estilizacao 3D leve ok; sem anime). Preserve a mesma "
    "roupa, pose, enquadramento (meio corpo) e fundo — NAO copie o close da "
    "foto nem aumente a cabeca. NAO invente franja. NAO 'corrija' tracos atipicos. "
