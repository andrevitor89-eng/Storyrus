...
_SYSTEM_PT = (
    ...
    "ESPAÇO: antes de escrever, defina em 1 frase onde a história acontece (lugar "
    "concreto e sensorial), o que esse espaço já revela sobre o traço central da "
    "criança, e como ele contém literalmente o objetivo educacional (ex.: contar "
    "objetos → quarto cheio de blocos). O espaço muda pouco ao longo do livro, mas "
    "ganha um detalhe novo no clímax — sinal visual de que algo mudou por dentro da "
    "criança.\n\n"
...
_SYSTEM_EN = (
    ...
    "SETTING: before writing, define in 1 sentence where the story happens (a "
    "concrete, sensory place), what that setting already reveals about the child's "
    "starting trait, and how it literally contains the learning goal (e.g., counting "
    "objects → a room full of blocks). The setting changes little across the book, "
    "but gains a new detail at the climax — a visual sign that something changed "
    "inside the child.\n\n"
